...
public class APIStatusTableModel extends AbstractTableModel {
	...
	private IAPIStatesDTO states = null;
	...
	public int getRowCount() {
		return this.states != null ? this.states.getStatesMapedByURL().size() : 0;
	}
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		if (this.states != null) {
			final SortedMap<String, IAPIStateDTO> statesMap = this.states.getStatesMapedByURL();
