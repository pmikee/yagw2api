...
public class MainWindow extends AbstractWindow {
	...
	private JPanel initSelectionPanel() {
		...
		c2.setHeaderValue("Blau");
		tcm.addColumn(c2);
		final TableColumn c3 = new TableColumn(2);
		c3.setHeaderValue("Rot");
		tcm.addColumn(c3);
	...
	private JPanel initEternalPanel() {
		...
		eternalTable = new JTable(this.eternalMapModel);
		eternalPanel.add(eternalTable, BorderLayout.CENTER);
		return eternalPanel;
	}
	...
	private JPanel initGreenPanel() {
		...
		greenTable = new JTable(this.greenMapModel);
		greenPanel.add(greenTable, BorderLayout.CENTER);
		return greenPanel;
	}
	...
	private JPanel initBluePanel() {
		...
		blueTable = new JTable(this.blueMapModel);
		bluePanel.add(blueTable, BorderLayout.CENTER);
		return bluePanel;
	}
	...
	private JPanel initRedPanel() {
		...
		redTable = new JTable(this.redMapModel);
		redPanel.add(redTable, BorderLayout.CENTER);
		return redPanel;
	}
