...
class DelegatingMapContinent implements MapContinentDTO {
	...
	/**
	 * @return
	 * @see de.justi.yagw2api.arenanet.v1.dto.map.MapContinentDTO#getName()
	 */
	@Override
	...
	/**
	 * @return
	 * @see de.justi.yagw2api.arenanet.v1.dto.map.MapContinentDTO#getDimension()
	 */
	@Override
	...
	/**
	 * @return
	 * @see de.justi.yagw2api.arenanet.v1.dto.map.MapContinentDTO#getMinZoom()
	 */
	@Override
	...
	/**
	 * @return
	 * @see de.justi.yagw2api.arenanet.v1.dto.map.MapContinentDTO#getMaxZoom()
	 */
	@Override
	...
	/**
	 * @return
	 * @see de.justi.yagw2api.arenanet.v1.dto.map.MapContinentDTO#getFloors()
	 */
	@Override
