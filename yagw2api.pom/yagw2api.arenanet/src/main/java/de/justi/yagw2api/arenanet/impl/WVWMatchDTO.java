...
final class WVWMatchDTO implements IWVWMatchDTO {
	...
	@Override
	public Optional<IWorldNameDTO> getRedWorldName(final Locale locale) {
		checkNotNull(locale);
	...
	@Override
	public Optional<IWorldNameDTO> getGreenWorldName(final Locale locale) {
		checkNotNull(locale);
	...
	@Override
	public Optional<IWorldNameDTO> getBlueWorldName(final Locale locale) {
		checkNotNull(locale);
