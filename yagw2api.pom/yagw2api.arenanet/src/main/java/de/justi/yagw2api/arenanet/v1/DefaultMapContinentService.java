...
import de.justi.yagw2api.arenanet.v1.dto.map.MapContinentDTO;
import de.justi.yagw2api.arenanet.v1.dto.map.MapContinentWithIdDTO;
import de.justi.yagw2api.arenanet.v1.dto.map.MapContinentsDTO;
...
final class DefaultMapContinentService implements MapContinentService {
	...
	public Iterable<MapContinentWithIdDTO> retrieveAllContinents() {
		return this.retrieveAllContinents(YAGW2APIArenanetV1.INSTANCE.getCurrentLocale());
	}
}
