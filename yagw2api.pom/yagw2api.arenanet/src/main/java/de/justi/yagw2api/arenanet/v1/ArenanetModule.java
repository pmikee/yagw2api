...
import de.justi.yagw2api.arenanet.v1.dto.guild.DefaultGuildDTOFactory;
import de.justi.yagw2api.arenanet.v1.dto.guild.GuildDTOFactory;
import de.justi.yagw2api.arenanet.v1.dto.map.DefaultMapDTOFactory;
import de.justi.yagw2api.arenanet.v1.dto.map.MapDTOFactory;
import de.justi.yagw2api.arenanet.v1.dto.world.DefaultWorldDTOFactory;
import de.justi.yagw2api.arenanet.v1.dto.world.WorldDTOFactory;
import de.justi.yagw2api.arenanet.v1.dto.wvw.DefaultWVWDTOFactory;
import de.justi.yagw2api.arenanet.v1.dto.wvw.WVWDTOFactory;

public final class ArenanetModule extends AbstractModule {
