...
final class WorldDTOFactory extends AbstractGSONFactory implements IWorldDTOFactory {
	...
	@Override
	public IWorldNameDTO[] newWorldNamesOf(final String json) {
		WorldNameDTO[] result;
		try {
			result = this.getGSON().fromJson(checkNotNull(json), WorldNameDTO[].class);
