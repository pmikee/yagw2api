...
final class DefaultWVWObjectiveUnclaimedEvent extends AbstractWVWObjectiveEvent implements WVWObjectiveUnclaimedEvent {
	private final Optional<Guild> previousClaimedByGuild;

	public DefaultWVWObjectiveUnclaimedEvent(final WVWObjective source, final Guild previousClaimedByGuild) {
		super(source);
