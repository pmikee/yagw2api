...
public final class WVWModelFactory implements IWVWModelFactory {
	...
	@Override
	public IWVWScores newMapScores(final IWVWMap map) {
	...
	@Override
	public IWVWScores newMatchScores(final IWVWMatch match) {
