...
public enum DefaultWVWObjectiveType implements WVWObjectiveType {
	...
	private DefaultWVWObjectiveType(final long buffDuration, final TimeUnit buffDurationTimeUnit, final int points) {
