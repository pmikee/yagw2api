...
public abstract class AbstractMatchIdAction<A extends AbstractMatchIdAction<?>> extends RecursiveAction{
	...
	public AbstractMatchIdAction(List<String> matchIds, int chunkSize){
		this(ImmutableList.copyOf(checkNotNull(matchIds)), chunkSize,0, matchIds.size());
	}
	protected AbstractMatchIdAction(List<String> matchIds, int chunkSize, int fromInclusive, int toExclusive){
